...
- Bold panel letters at each panel's upper-left; put compact descriptions above the axes frame line as panel captions, independent of the letter. Place top-right quiver keys on the caption baseline. No figure-level `suptitle`, figure-level captions, default centered axis titles, or data stamps.
